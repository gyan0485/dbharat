  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2024-2025 <a href="<?php echo e(route('admin.dashboard')); ?>">Admin</a>.</strong>
    All rights reserved.
  </footer>
...
<script src="<?php echo e(url('')); ?>/asset/plugins/jqvmap/maps/jquery.vmap.usa.js"></script>
<!-- jQuery Knob Chart -->
...
</html><?php /**PATH C:\xampp\htdocs\AdminDashboard\resources\views/admin/layout/footer.blade.php ENDPATH**/ ?>