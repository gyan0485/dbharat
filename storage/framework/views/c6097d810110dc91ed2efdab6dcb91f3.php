  ...
  <script>
    $(document).ready(function() {
      ...
      $('#email-form').on('submit', function(e) {
        e.preventDefault();
        var email = $('#email').val();
        $.post('<?php echo e(route("forgot.password.post")); ?>', {
            email: email
          })
          .done(function(data) {
            if (data.success) {
...
</html><?php /**PATH C:\xampp\htdocs\AdminDashboard\resources\views/admin/password/forgot-password.blade.php ENDPATH**/ ?>